...
url1='https://www.youtube.com/watch?v=Rp0_YIw67fI&list=PLz8TdOA7NTzSMvlDZc4F8r71o4FKaRPU5'
url2='https://www.youtube.com/watch?v=hvlhApgCov4&list=PLz8TdOA7NTzSMvlDZc4F8r71o4FKaRPU5&index=3'
url3='https://www.youtube.com/watch?v=Z20JgQzhHdY&list=PLz8TdOA7NTzSMvlDZc4F8r71o4FKaRPU5&index=9'
url4='https://www.youtube.com/watch?v=JImmUDWJFdk&list=PLz8TdOA7NTzSMvlDZc4F8r71o4FKaRPU5&index=32'
url5='https://www.youtube.com/watch?v=KnU9LJlb_P0&list=PLz8TdOA7NTzSMvlDZc4F8r71o4FKaRPU5&index=85'
...
centerlabel=Label(top,text="Data Structures",font=("Oswald",42),background="#2B2B28",fg="white")
centerlabel.place(x=350,y=20)
...
topic22=Button(top,text="LINKED LISTS",font=("Oswald",18),background='#2B2B28',fg="White",command=click2)
...
topic32=Button(top,text="STACKS AND QUEUES",font=("Oswald",18),background='#2B2B28',fg="White",command=click3)
...
topic42=Button(top,text="TREES AND GRAPHS",font=("Oswald",18),background='#2B2B28',fg="White",command=click4)
...
topic52=Button(top,text="SEARCHING AND SORTING CONCEPTS",font=("Oswald",18),background='#2B2B28',fg="White",command=click5)

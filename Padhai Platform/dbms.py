...
url1='https://www.youtube.com/watch?v=qgAjKmjswBc&list=PLz8TdOA7NTzToibk7WXtD5qvBMnkZkwh7'
url2='https://www.youtube.com/watch?v=BEvUxMl97mw&list=PLz8TdOA7NTzToibk7WXtD5qvBMnkZkwh7&index=17'
url3='https://www.youtube.com/watch?v=L6_QoM1aagc&list=PLz8TdOA7NTzToibk7WXtD5qvBMnkZkwh7&index=29'
url4='https://www.youtube.com/watch?v=eiKcAQTFkbA&list=PLz8TdOA7NTzToibk7WXtD5qvBMnkZkwh7&index=46'
url5='https://www.youtube.com/watch?v=Fdb86Ia6h2c&list=PLz8TdOA7NTzToibk7WXtD5qvBMnkZkwh7&index=43'
...
centerlabel=Label(top,text="DBMS",font=("Oswald",42),background="#2B2B28",fg="white")
...
topic22=Button(top,text="E-R MODEL",font=("Oswald",18),background='#2B2B28',fg="White",command=click2)
...
topic32=Button(top,text="NORMALIZATION",font=("Oswald",18),background='#2B2B28',fg="White",command=click3)
...
topic42=Button(top,text="SQL",font=("Oswald",18),background='#2B2B28',fg="White",command=click4)
...
topic52=Button(top,text="TRANSACTION AND RECOVERY",font=("Oswald",18),background='#2B2B28',fg="White",command=click5)

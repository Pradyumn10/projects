...
url1='https://www.youtube.com/watch?v=xg60VxyK-9I'
url2='https://www.youtube.com/watch?v=xg60VxyK-9I'
url3='https://www.youtube.com/watch?v=xg60VxyK-9I'
url4='https://www.youtube.com/watch?v=xg60VxyK-9I'
url5='https://www.youtube.com/watch?v=xg60VxyK-9I'
...
centerlabel=Label(top,text="German",font=("Oswald",42),background="#2B2B28",fg="white")
centerlabel.place(x=450,y=30)
...
topic22=Button(top,text="COUNTING",font=("Oswald",18),background='#2B2B28',fg="White",command=click2)
...
topic32=Button(top,text="VERBEN",font=("Oswald",18),background='#2B2B28',fg="White",command=click3)
...
topic42=Button(top,text="ARTIKELS",font=("Oswald",18),background='#2B2B28',fg="White",command=click4)
...
topic52=Button(top,text="SATZE",font=("Oswald",18),background='#2B2B28',fg="White",command=click5)
